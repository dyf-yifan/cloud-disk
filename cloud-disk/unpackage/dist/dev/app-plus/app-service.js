...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _navBar = _interopRequireDefault(__webpack_require__(/*! @/components/common/nav-bar.vue */ 7));\nvar _fList = _interopRequireDefault(__webpack_require__(/*! @/components/common/f-list.vue */ 18));\nvar _fDialog = _interopRequireDefault(__webpack_require__(/*! @/components/common/f-dialog.vue */ 23));\nvar _uniPopup = _interopRequireDefault(__webpack_require__(/*! @/components/uni-ui/uni-popup/uni-popup.vue */ 28));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { data: function data() {return { newdirname: '', renameValue: '', list: [{ type: 'dir', name: '我的笔记', create_time: '2020-10-21 08:00', checked: false }, { type: 'image', name: '风景.jpg', data: 'https://avatars2.githubusercontent.com/u/55441045?s=400&v=4', checked: false }, { type: 'video', name: 'uniapp实战教程.mp4', data: 'https://aweme.snssdk.com/aweme/v1/playwm/?video_id=v0200fba0000bpo4s1b82vu9dp4ehlog&line=0', create_time: '2020-10-21 08:00', checked: false }, { type: 'text', name: '记事本.txt', create_time: '2020-10-21 08:00', checked: false }, { type: 'none', name: '压缩包.rar', create_time: '2020-10-21 08:00', checked: false }], addList: [{ icon: 'icon-shangchuantupian', color: 'text-success', name: '上传图片' }, { icon: 'icon-shangchuanshipin', color: 'text-primary', name: '上传视频' }, { icon: 'icon-shangchuanwenjian', color: 'text-muted', name: '上传文件' }, { icon: 'icon-xinjianwenjianjia', color: 'text-warning', name: '新建文件夹' }] };}, onLoad: function onLoad() {}, methods: { select: function select(e) {//接受到子组件传递过来的索引选中状态，将对应的list中的数据更新\n      this.list[e.index].checked = e.value;}, //全选、取消全选\n    handleCheckAll: function handleCheckAll(checked) {this.list.forEach(function (item) {item.checked = checked;});}, // 处理底部操作条事件，这里仅对“删除”做了处理\n    handleBottomEvent: function handleBottomEvent(item) {var _this = this;switch (item.name) {case '删除':this.$refs.delete.open(function (close) {_this.list = _this.list.filter(function (item) {return !item.checked;});close();\n            uni.showToast({\n              title: '删除成功',\n              icon: 'none' });\n\n          });\n          break;\n        case '重命名':\n          // 重命名只能对单个文件进行，所以取thi.checkList[0]，也就是选中的唯一元素\n          this.renameValue = this.checkList[0].name;\n          this.$refs.rename.open(function (close) {\n            if (_this.renameValue == '') {\n              return uni.showToast({\n                title: '文件名不能为空',\n                icon: 'none' });\n\n            }\n            // 更新该元素的name值，实时看到效果\n            _this.checkList[0].name = _this.renameValue;\n            close();\n          });\n          break;\n        default:\n          break;}\n\n    },\n    // 处理添加操作条的各种事件\n    handleAddEvent: function handleAddEvent(item) {var _this2 = this;\n      this.$refs.add.close();\n      switch (item.name) {\n        case '新建文件夹':\n          this.$refs.newdir.open(function (close) {\n            if (_this2.newdirname == '') {\n              return uni.showToast({\n                title: '文件夹名称不能为空',\n                icon: 'none' });\n\n            }\n            // 模拟请求服务器，这里先增加到list数组中\n            _this2.list.push({\n              type: 'dir',\n              name: _this2.newdirname,\n              create_time: '2020-10-22 17:00',\n              checked: false });\n\n            uni.showToast({\n              title: '新建文件夹成功',\n              icon: 'none' });\n\n            close();\n          });\n          break;\n        default:\n          break;}\n\n    },\n    openAddDialog: function openAddDialog() {\n      this.$refs.add.open();\n    },\n    // \n    doEvent: function doEvent(item) {\n      // 列表点击事件\n      switch (item.type) {\n        case 'image': //预览图片\n          var images = this.list.filter(function (item) {\n            return item.type === 'image';\n          });\n          uni.previewImage({\n            current: item.data,\n            urls: images.map(function (item) {return item.data;}) });\n\n          break;\n        case 'video':\n          uni.navigateTo({\n            url: '../video/video?url=' + item.data + '&title=' + item.name });\n\n        default:\n          break;}\n\n    } },\n\n  components: {\n    navBar: _navBar.default,\n    fList: _fList.default,\n    fDialog: _fDialog.default,\n    uniPopup: _uniPopup.default },\n\n  computed: {\n    //选中列表\n    checkList: function checkList() {\n      return this.list.filter(function (item) {return item.checked;});\n    },\n    //选中数量\n    checkCount: function checkCount() {\n      return this.checkList.length;\n    },\n    //操作菜单\n    actions: function actions() {\n      if (this.checkCount > 1) {\n        return [\n        {\n          icon: 'icon-xiazai',\n          name: '下载' },\n\n        {\n          icon: 'icon-shanchu',\n          name: '删除' }];\n\n\n      }\n      return [\n      {\n        icon: 'icon-xiazai',\n        name: '下载' },\n\n      {\n        icon: 'icon-fenxiang',\n        name: '分享' },\n\n      {\n        icon: 'icon-shanchu',\n        name: '删除' },\n\n      {\n        icon: 'icon-chongmingming',\n        name: '重命名' }];\n\n\n    } } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///6\n");
